...
export const PROCESS_STEPS: ProcessStep[] = [
  {
    number: '01',
    title: 'Brief Project',
    desc: 'Ceritakan apa yang kamu butuhkan — lewat form brief di website atau langsung WhatsApp. Kami baca semuanya sebelum balas, jadi nggak ada pertanyaan yang diulang dua kali.',
    icon: 'FileText',
  },
  {
    number: '02',
    title: 'Proposal & Estimasi',
    desc: 'Dalam 1–2 hari kerja kami kirim proposal lengkap: ruang lingkup, timeline, dan harga. Mau revisi scope atau nego anggaran? Wajar — kita diskusi dulu sampai semuanya pas.',
    icon: 'ClipboardList',
  },
  {
    number: '03',
    title: 'Kontrak & Kickoff',
    desc: 'Setelah deal, kontrak ditandatangani dan DP dikirim. Kami langsung setup repo, staging environment, dan project tracker. Dari sini project resmi berjalan.',
    icon: 'Handshake',
  },
  {
    number: '04',
    title: 'Development',
    desc: 'Pengerjaan berjalan di staging yang bisa kamu akses kapan saja. Tiap fase selesai kami kabari — kamu cek, coba, dan beri feedback sebelum kami lanjut ke fase berikutnya.',
    icon: 'Code2',
  },
  {
    number: '05',
    title: 'Deploy & Support',
    desc: 'Kalau kamu sudah setuju semua beres, kita deploy bareng ke production. Source code diserahkan penuh, dan kami cover bug fixes selama 30 hari setelah rilis.',
    icon: 'Rocket',
  },
]
...
export const PORTFOLIO_PROJECTS: Project[] = [
  {
    ...
    category: 'Enterprise',
    desc: 'Sistem ERP skala perusahaan dengan modul inventory, fleet management, laporan keuangan real-time, dan approval workflow multi-level.',
    tech: ['Next.js', 'FastAPI', 'PostgreSQL', 'Docker'],
    year: '2024',
    color: '#0A84FF',
  },
  {
    ...
    title: 'Mobile Commerce & Delivery',
    category: 'Mobile',
    desc: 'Aplikasi Android & iOS dengan sistem subscription, payment gateway terintegrasi, live tracking pengiriman, dan push notification real-time.',
    tech: ['Flutter', 'FastAPI', 'Midtrans', 'Firebase'],
    year: '2024',
    color: '#FF9F0A',
  },
  {
    ...
    category: 'AI',
    desc: 'Platform analitik berbasis ML untuk prediksi permintaan, deteksi anomali, dan rekomendasi bisnis dengan akurasi model di atas 90%.',
...
export const PORTFOLIO_CATEGORIES = ['Semua', 'Enterprise', 'Mobile', 'AI'] as const
